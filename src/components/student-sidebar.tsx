    ...
    <>
        <SidebarHeader>
            <div className="flex h-16 items-center px-2">
                <Link href="/dashboard/student" className="flex items-center gap-2 font-semibold font-headline">
            ...
            <SidebarMenu>
                {navItems.map(({ href, label, icon: Icon, badge }) => (
                    <SidebarMenuItem key={href+label}>
                        <SidebarMenuButton
                            asChild
                            isActive={pathname.startsWith(href) && (href !== '/dashboard/student' || pathname === '/dashboard/student')}
                            tooltip={{
                                children: label,
                                side: "right",
                            }}
