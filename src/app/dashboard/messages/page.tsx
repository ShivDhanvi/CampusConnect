...
const users = {
  admin: { name: 'Admin', avatar: 'https://placehold.co/40x40.png', initials: 'AD', role: 'Admin' },
  teacher1: { name: 'Mr. Smith', avatar: 'https://placehold.co/40x40.png', initials: 'MS', role: 'Teacher' },
  student1: { name: 'John Doe', avatar: 'https://placehold.co/40x40.png', initials: 'JD', role: 'Student' },
  parent1: { name: 'Jane Doe', avatar: 'https://placehold.co/40x40.png', initials: 'JD', role: 'Parent' },
  teacher2: { name: 'Ms. Jones', avatar: 'https://placehold.co/40x40.png', initials: 'MJ', role: 'Teacher' },
  student2: { name: 'Sarah Miller', avatar: 'https://placehold.co/40x40.png', initials: 'SM', role: 'Student' },
};
...
const conversationsData = [
  ...
  },
  {
    ...
    lastMessage: 'Hello Mrs. Doe, the deadline for this term is October 25th. You can pay online via the portal.',
  ...
  },
  {
    ...
    lastMessage: 'Mr. Smith, I have a question about the history assignment.',
    lastMessageTime: '9:00 AM',
  },
  {
    id: 'conv4',
    participants: ['teacher2', 'student2'],
    messages: [
      { sender: 'teacher2', text: 'Hi Sarah, great job on your last science project!', timestamp: '2 days ago' },
      { sender: 'student2', text: 'Thank you, Ms. Jones!', timestamp: '2 days ago' },
    ],
    lastMessage: 'Thank you, Ms. Jones!',
                                    ...
                                    <div className="space-y-6">
                                        {selectedConversation.messages.map((msg, index) => (
                                            <div key={index} className={cn("flex gap-3", msg.sender === CURRENT_USER_ID ? "justify-end" : "justify-start")}>
                                                ...
                                                <div className={cn("max-w-xs md:max-w-md p-3 rounded-2xl", msg.sender === CURRENT_USER_ID ? "bg-primary text-primary-foreground" : "bg-muted")}>
                                                    <p className="text-sm">{msg.text}</p>
                                                    <p className={cn("text-xs mt-1", msg.sender === CURRENT_USER_ID ? "text-primary-foreground/70" : "text-muted-foreground")}>{msg.timestamp}</p>
                                                </div>
